...
| wq-accessibility | 1 · inceleme çekirdeği | addyosmani/web-quality-skills | `afa8da9` 2026-08-24 | MIT | TEMİZ (2 istisna) | 464 | improve accessibility, a11y audit, WCAG compliance, screen reader support |
| ux-designer | 2 · UX bilgi tabanı | szilu/ux-designer-skill | `da9e9d0` 2026-08-14 | MIT | TEMİZ (4 istisna) | 322 | UX/UI design principles for building and critiquing interfaces. Use fo… |
| design-taste-frontend | 3 · tasarım yönü (üretim) | Leonxlnx/taste-skill | `3c7017d` 2026-05-26 | MIT | TEMİZ | 1206 | Anti-slop frontend skill for landing pages, portfolios, and redesigns.… |
...
| motion-design | 4 · hareket | LottieFiles/motion-design-skill | `b6606e1` 2026-03-12 | MIT | TEMİZ | 315 | > |
| wq-best-practices | 5 · web kalitesi | addyosmani/web-quality-skills | `afa8da9` 2026-08-24 | MIT | TEMİZ (2 istisna) | 480 | apply best practices, security audit, modernize code, code quality review |
...
| wq-performance | 5 · web kalitesi | addyosmani/web-quality-skills | `afa8da9` 2026-08-24 | MIT | TEMİZ (1 istisna) | 399 | speed up my site, optimize performance, reduce load time, fix slow loading |
| wq-seo | 5 · web kalitesi | addyosmani/web-quality-skills | `afa8da9` 2026-08-24 | MIT | TEMİZ (1 istisna) | 409 | improve SEO, optimize for search, fix meta tags, add structured data |
