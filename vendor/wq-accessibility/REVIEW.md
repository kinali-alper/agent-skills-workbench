# REVIEW — wq-accessibility

| Alan | Değer |
|---|---|
| Kaynak | addyosmani/web-quality-skills · skills/accessibility · commit afa8da9 (2026-08-24) · MIT |
| Alınma | 2026-09-18, git clone --depth 1 → yalnız skill klasörü kopyalandı |
| Denetim | skill-audit.sh → UYARI → hepsi açıklama yorumu / örnek kod, yanlış alarm |
...
- WCAG 2.2 A/AA kriterleri + references/WCAG.md, A11Y-PATTERNS.md. BrokenForm'daki 9 kör noktayla karşılaştırılacak.
